...
public class GraphFactoryImpl extends EFactoryImpl implements GraphFactory {
	...
	public static GraphFactory init() {
		try {
			GraphFactory theGraphFactory = (GraphFactory)EPackage.Registry.INSTANCE.getEFactory("http:///com/efandei/memori/graph.ecore"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case GraphPackage.GRAPH_INTF: return createGraphIntf();
			default:
	 ...
	 * @generated
	 */
	public GraphIntf createGraphIntf() {
		GraphIntfImpl graphIntf = new GraphIntfImpl();
		return graphIntf;
	}
